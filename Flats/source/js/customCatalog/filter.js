  ...
  $(document).ready(function () {
    ...
    let getPointData = function (index, complex) {
      return {
        ...
        balloonContentBody: '<div class="map-flat"><div class="map-flat__img"><img class="lazy" src="' + complex[index]
    ...
    function initSlidersComplexes(slider) {
      if ($(slider).length) {
        ...
        $(slider).slick({
          ...
          adaptiveHeight: true,
          arrows: true,
          prevArrow: '<button id="prev" type="button" class="catalog-complex__slider-prev-btn"><img class="lazy" src="img/catalog-slider-prev.svg" alt="img"></button>',
          nextArrow: '<button id="next" type="button" class="catalog-complex__slider-next-btn"><img class="lazy" src="img/catalog-slider-next.svg" alt="img"></button>',
        });
    ...
    function showComplex(infoList, parent) {//parent-родитель куда будут добавляться данные
      ...
      if ($(parent).hasClass('map__complex-info-inner')) {
        ...
        str += '</div><button type="button" data-phone="'+infoList.tel+'" class="btn-phone"><img class="img-phone lazy" src="img/icon-phone.svg" alt="img"><span class="text">+7 Показать телефон</span></button><a href="detail.html" class="btn-details pink__btn">Подробнее</a></div></div>';
      } else {
        str += '</div><div class="catalog-complex__description"><p class="description">' + infoList.description + '</p></div><div class="catalog-complex__buttons-wrap"><a href="detail.html" class="catalog-complex__btn-more pink__btn">Подробнее</a><button type="button" data-id-complex="'+infoList.id+'"class="catalog-complex__btn-show-map pink__btn"><img class="lazy" src="img/placeholder-red.svg" alt="img">На карте</button></div></div></div>';
      }
